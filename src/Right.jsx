...
import FollowUser from "./components/FollowUser.jsx";
import Trend from "./components/Trend.jsx";
import { followUsers, trendList } from "./data.js";

function FollowUsersList() {
  const followUsersList = followUsers.map((followUser, index) => {
    return (
      <>
        <FollowUser
          key={index}
...
function TrendList() {
  const trends = trendList.map((trend, index) => {
    return (
      <>
        <Trend
          key={index}
